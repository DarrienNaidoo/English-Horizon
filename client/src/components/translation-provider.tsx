...
const translations: Record<string, string> = {
  ...
  'Manage students, groups, and competitions': '管理学生、小组和比赛',
  'Active Groups': '活跃小组',
  ...
  'Active Challenges': '活跃挑战',
  'Competition Management': '比赛管理',
  'Create Competition': '创建比赛',
  'Class Competitions': '班级比赛',
  'Global Competitions': '全球比赛',
  'Ends:': '结束时间：',
  'Manage': '管理',
  'Reward System': '奖励系统',
  'Add Reward': '添加奖励',
  'Cost:': '费用：',
  'Seasonal Bonuses': '季节性奖励',
  'multiplier': '倍数',
  'individual': '个人',
  'group': '小组',
  'class vs class': '班级对战',
  ...
  'intermediate': '中级',
  'advanced': '高级',
  'speaking master': '口语大师',
  'vocabulary champion': '词汇冠军',
  'consistent learner': '坚持学习者',
  'grammar guru': '语法专家',
  'cultural explorer': '文化探索者',
  'debate champion': '辩论冠军',
  'Skip Homework Pass': '免作业券',
  'Skip one homework assignment': '跳过一次作业',
  'Class Helper Badge': '班级助手徽章',
  'Be the teacher\'s assistant for a day': '当一天老师助手',
  'Sticker Pack': '贴纸包',
  'Cool English learning stickers': '酷炫英语学习贴纸',
  'Mid-Autumn Festival Bonus': '中秋节奖励',
  'Celebrate Chinese culture with bonus points!': '庆祝中华文化，获得奖励积分！',
